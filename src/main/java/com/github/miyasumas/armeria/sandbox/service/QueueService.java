...
public class QueueService {
	...
	public interface Iface {
		...
		public QueueResponse enqueue(QueueRequest request) throws org.apache.thrift.TException;

	}

	public interface AsyncIface {

		public void enqueue(QueueRequest request, org.apache.thrift.async.AsyncMethodCallback resultHandler)
	...
	public static class Client extends org.apache.thrift.TServiceClient implements Iface {
		...
		public void sendEnqueue(QueueRequest request) throws org.apache.thrift.TException {
			enqueue_args args = new enqueue_args();
			args.setRequest(request);
			sendBase("enqueue", args);
		}

		public QueueResponse recvEnqueue() throws org.apache.thrift.TException {
	...
	public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
		...
		public void enqueue(QueueRequest request, org.apache.thrift.async.AsyncMethodCallback resultHandler)
			throws org.apache.thrift.TException {
			checkReady();
			enqueue_call method_call = new enqueue_call(request, resultHandler, this, ___protocolFactory, ___transport);
		...
		public static class enqueue_call extends org.apache.thrift.async.TAsyncMethodCall {
			...
			public enqueue_call(QueueRequest request, org.apache.thrift.async.AsyncMethodCallback resultHandler,
			...
			public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
				prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("enqueue",
			...
			public QueueResponse getResult() throws org.apache.thrift.TException {
				...
				return (new Client(prot)).recvEnqueue();
			}
		}
	...
	public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I>
		...
		public static class enqueue<I extends Iface> extends org.apache.thrift.ProcessFunction<I, enqueue_args> {
			public enqueue() {
				super("enqueue");
			}
			...
			public enqueue_result getResult(I iface, enqueue_args args) throws org.apache.thrift.TException {
				enqueue_result result = new enqueue_result();
				result.success = iface.enqueue(args.request);
				return result;
			}
		}
	...
	public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
		...
		public static class enqueue<I extends AsyncIface>
			extends org.apache.thrift.AsyncProcessFunction<I, enqueue_args, QueueResponse> {
			public enqueue() {
				super("enqueue");
			}
			...
			public AsyncMethodCallback<QueueResponse> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
				final org.apache.thrift.AsyncProcessFunction fcall = this;
				return new AsyncMethodCallback<QueueResponse>() {
					public void onComplete(QueueResponse o) {
						enqueue_result result = new enqueue_result();
						result.success = o;
						try {
			...
			public void start(I iface, enqueue_args args,
				org.apache.thrift.async.AsyncMethodCallback<QueueResponse> resultHandler) throws TException {
				iface.enqueue(args.request, resultHandler);
			}
		}

	}

	public static class enqueue_args implements org.apache.thrift.TBase<enqueue_args, enqueue_args._Fields>,
		java.io.Serializable, Cloneable, Comparable<enqueue_args> {
		...
		public QueueRequest request; // required
		...
		public enqueue_args(enqueue_args other) {
			if (other.isSetRequest()) {
				this.request = new QueueRequest(other.request);
			}
		}
		...
		public enqueue_args setRequest(QueueRequest request) {
			this.request = request;
			return this;
		}
		...
		private static class enqueue_argsStandardScheme extends StandardScheme<enqueue_args> {
			...
			public void read(org.apache.thrift.protocol.TProtocol iprot, enqueue_args struct)
				throws org.apache.thrift.TException {
				...
				while (true) {
					...
					case 1: // REQUEST
						if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
							struct.request = new QueueRequest();
			...
			public void write(org.apache.thrift.protocol.TProtocol oprot, enqueue_args struct)
				throws org.apache.thrift.TException {
				struct.validate();
		...
		private static class enqueue_argsTupleScheme extends TupleScheme<enqueue_args> {
			...
			@Override
			public void write(org.apache.thrift.protocol.TProtocol prot, enqueue_args struct)
				throws org.apache.thrift.TException {
			...
			@Override
			public void read(org.apache.thrift.protocol.TProtocol prot, enqueue_args struct)
				throws org.apache.thrift.TException {
	...
	public static class enqueue_result implements org.apache.thrift.TBase<enqueue_result, enqueue_result._Fields>,
		java.io.Serializable, Cloneable, Comparable<enqueue_result> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
			"enqueue_result");
		...
		public QueueResponse success; // required
		...
		private static class enqueue_resultStandardScheme extends StandardScheme<enqueue_result> {
			...
			public void read(org.apache.thrift.protocol.TProtocol iprot, enqueue_result struct)
				throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TField schemeField;
				iprot.readStructBegin();
				while (true) {
					...
					case 0: // SUCCESS
						if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
							struct.success = new QueueResponse();
			...
			public void write(org.apache.thrift.protocol.TProtocol oprot, enqueue_result struct)
				throws org.apache.thrift.TException {
				struct.validate();
		...
		private static class enqueue_resultTupleScheme extends TupleScheme<enqueue_result> {
			...
			@Override
			public void write(org.apache.thrift.protocol.TProtocol prot, enqueue_result struct)
				throws org.apache.thrift.TException {
				TTupleProtocol oprot = (TTupleProtocol) prot;
				BitSet optionals = new BitSet();
			...
			@Override
			public void read(org.apache.thrift.protocol.TProtocol prot, enqueue_result struct)
				throws org.apache.thrift.TException {
				TTupleProtocol iprot = (TTupleProtocol) prot;
				BitSet incoming = iprot.readBitSet(1);
				if (incoming.get(0)) {
